...
| Arquivo | O que é |
|---|---|
| [`ESTADO_DA_TRIAGEM.md`](02-experimentos/ESTADO_DA_TRIAGEM.md) | **Estado operacional da triagem e retomada de contexto** (a Seção 0.R resume tudo para uma sessão nova). As duas máquinas e o que roda em cada uma, o ciclo commit-push-pull entre elas, a máquina remota ser compartilhada, os bugs de infraestrutura já corrigidos, quais smoke tests passaram e o que falta, e as questões em aberto. Comece por aqui ao retomar a triagem. |
